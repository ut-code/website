...
function EventInfoItem(props: { title: string; children: ReactNode }) {
  ...
  return (
    <section className="flex flex-col md:flex-row text-left items-left space-y-2 md:space-y-0 md:space-x-10">
      <h3 className="self-start bg-[#549C48] font-semibold text-white md:text-center w-full md:w-24 rounded-full px-6 md:px-4 py-2">
        {title}
      </h3>
...
function EventSummarySection() {
  return (
    <section className="bg-[#F7FFE5] p-5 space-y-8 rounded-3xl">
    ...
    <div className="flex flex-col md:flex-row md:justify-between items-center space-y-12 md:space-y-0 px-5">
      ...
      <div className="text-center space-y-2">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="bg-[#ED9E28] font-semibold text-white text-xl w-full md:w-64 rounded-full inline-block px-8 py-4 hover:bg-amber-600 hover:shadow-lg hover:scale-105"
