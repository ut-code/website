...
categories:
  - "events"
image: ./image.jpg
slug: 2023-summer-hackathon-review
---

ut.code(); では、8 月 17 日〜19 日に、ハッカソンイベントを開催しました。16 名の参加者が 4 チームに分かれてそれぞれプロダクト開発を行いました。完成したプロジェクトは GitHub で公開しています。
...
- URL: [https://call-paper.web.app/](https://call-paper.web.app/)
- GitHub: [https://github.com/ut-code/call-paper](https://github.com/ut-code/call-paper)

![call-paper](./call-paper.png)
